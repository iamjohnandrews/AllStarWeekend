...
$the_blogname   = 'All-Star Weekend VIP';
$the_myemail 	= 'advertise@allstarweekendvip.com';
...
if(isset($_POST['email'])){
		...
		{ 	
			...
			echo '<h3>Oops!</h3><div class="confirm">
					<p class="texterror">Due to an unknown error, your form was not submitted, please resubmit it, try later or email adverstise (at) allstarweekendvip.com.</p>
				  </div>'; 
